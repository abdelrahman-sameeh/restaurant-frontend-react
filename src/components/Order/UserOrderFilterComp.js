...
import UserFilteringOrdersHook from "../../CustomHook/Order/UserFilteringOrdersHook";

const UserOrderFilterComp = () => {
  const [
    query,
    handleChangeOrderStatus,
    handleChangePaidOrder,
    handleChangeDeliveryOrder
  ] = UserFilteringOrdersHook();
...
export default UserOrderFilterComp;
